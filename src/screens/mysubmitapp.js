...
<Text style={{ color: 'white', fontWeight: 'bold' }}>Already Applied</Text>
</Button>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <Text style={styles.modalText}> <Text style={styles.modalText}>Are you want to sure to withdraw Application</Text></Text>
