...
function studentlogin(props){
    ...
    return(
          ...
          <View style={styles.container}>
            ...
            <Text style={{alignSelf:"center",fontSize:25,fontWeight:'250',fontWeight:'bold',color:'#8EC043',letterSpacing:2.5}}>My Credentials Is:</Text>
        ...
        <Button style={styles.signin} mode="contained"title="LOGIN" onPress={()=>props.navigation.navigate("studenthome")}><Text style={{letterSpacing:8.5,color:'white',fontWeight:'bold'}}>SIGN IN</Text></Button>


        <View style={styles.reg}>
          <Text style={styles.account}>Don't Have an account?</Text>

          <Text style={styles.register} onPress={()=>props.navigation.navigate("studentsignup")}>Regiter Now</Text>
